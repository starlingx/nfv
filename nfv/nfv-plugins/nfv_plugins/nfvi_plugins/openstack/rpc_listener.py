...
def test_connection(
    ...
    try:
        ...
        if connected:
            ...
            # fails.
            rpc_receive_queue = Queue(
                queue_name, durable=True, exchange=exchange, channel=connection
            )
        ...
        DLOG.info(
            "Unable to connect to virt_host %s, exchange %s, error: %s"
