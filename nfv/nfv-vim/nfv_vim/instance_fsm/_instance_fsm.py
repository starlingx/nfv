...
from nfv_vim.instance_fsm._instance_state_rebuild import RebuildState
from nfv_vim.instance_fsm._instance_state_resize import ResizeState
from nfv_vim.instance_fsm._instance_state_resize_confirm import ResizeConfirmState
from nfv_vim.instance_fsm._instance_state_resize_revert import ResizeRevertState
from nfv_vim.instance_fsm._instance_state_resume import ResumeState
from nfv_vim.instance_fsm._instance_state_start import StartState
from nfv_vim.instance_fsm._instance_state_stop import StopState
from nfv_vim.instance_fsm._instance_state_suspend import SuspendState
from nfv_vim.instance_fsm._instance_state_unpause import UnpauseState
...
INSTANCE_LIVE_MIGRATE_STATES = dict(
    [
        ...
        (INSTANCE_STATE.LIVE_MIGRATE, LiveMigrateState(INSTANCE_STATE.LIVE_MIGRATE)),
        (
...
INSTANCE_COLD_MIGRATE_STATES = dict(
    [
        ...
        (INSTANCE_STATE.COLD_MIGRATE, ColdMigrateState(INSTANCE_STATE.COLD_MIGRATE)),
        (
...
INSTANCE_EVACUATE_STATES = dict(
    [
        ...
        (INSTANCE_STATE.EVACUATE, EvacuateState(INSTANCE_STATE.EVACUATE)),
    ]
)
...
INSTANCE_START_STATES = dict(
    [
        ...
        (INSTANCE_STATE.START, StartState(INSTANCE_STATE.START)),
    ]
)
...
INSTANCE_STOP_STATES = dict(
    [
        ...
        (INSTANCE_STATE.STOP, StopState(INSTANCE_STATE.STOP)),
    ]
)
...
INSTANCE_PAUSE_STATES = dict(
    [
        ...
        (INSTANCE_STATE.PAUSE, PauseState(INSTANCE_STATE.PAUSE)),
    ]
)
...
INSTANCE_UNPAUSE_STATES = dict(
    [
        ...
        (INSTANCE_STATE.UNPAUSE, UnpauseState(INSTANCE_STATE.UNPAUSE)),
    ]
)
...
INSTANCE_SUSPEND_STATES = dict(
    [
        ...
        (INSTANCE_STATE.SUSPEND, SuspendState(INSTANCE_STATE.SUSPEND)),
    ]
)
...
INSTANCE_RESUME_STATES = dict(
    [
        ...
        (INSTANCE_STATE.RESUME, ResumeState(INSTANCE_STATE.RESUME)),
    ]
)
...
INSTANCE_REBOOT_STATES = dict(
    [
        ...
        (INSTANCE_STATE.REBOOT, RebootState(INSTANCE_STATE.REBOOT)),
    ]
)
...
INSTANCE_REBUILD_STATES = dict(
    [
        ...
        (INSTANCE_STATE.REBUILD, RebuildState(INSTANCE_STATE.REBUILD)),
    ]
)
...
INSTANCE_FAIL_STATES = dict(
    [
        ...
        (INSTANCE_STATE.FAIL, FailState(INSTANCE_STATE.FAIL)),
    ]
)
...
INSTANCE_DELETE_STATES = dict(
    [
        ...
        (INSTANCE_STATE.DELETE, DeleteState(INSTANCE_STATE.DELETE)),
    ]
)
...
INSTANCE_RESIZE_STATES = dict(
    [
        ...
        (INSTANCE_STATE.RESIZE, ResizeState(INSTANCE_STATE.RESIZE)),
    ]
)
...
INSTANCE_RESIZE_REVERT_STATES = dict(
    [
        ...
        (INSTANCE_STATE.RESIZE_REVERT, ResizeRevertState(INSTANCE_STATE.RESIZE_REVERT)),
    ]
)
...
INSTANCE_GUEST_SERVICES_CREATE_STATES = dict(
    [
        (
            INSTANCE_STATE.INITIAL,
            InitialState(INSTANCE_STATE.INITIAL, INSTANCE_STATE.GUEST_SERVICES_CREATE),
        ),
        (
...
INSTANCE_GUEST_SERVICES_ENABLE_STATES = dict(
    [
        (
            INSTANCE_STATE.INITIAL,
            InitialState(INSTANCE_STATE.INITIAL, INSTANCE_STATE.GUEST_SERVICES_ENABLE),
        ),
        (
...
INSTANCE_GUEST_SERVICES_DISABLE_STATES = dict(
    [
        (
            INSTANCE_STATE.INITIAL,
            InitialState(INSTANCE_STATE.INITIAL, INSTANCE_STATE.GUEST_SERVICES_DISABLE),
        ),
        (
...
INSTANCE_GUEST_SERVICES_SET_STATES = dict(
    [
        (
            INSTANCE_STATE.INITIAL,
            InitialState(INSTANCE_STATE.INITIAL, INSTANCE_STATE.GUEST_SERVICES_SET),
        ),
        (
...
INSTANCE_GUEST_SERVICES_DELETE_STATES = dict(
    [
        (
            INSTANCE_STATE.INITIAL,
            InitialState(INSTANCE_STATE.INITIAL, INSTANCE_STATE.GUEST_SERVICES_DELETE),
        ),
        (
...
class FailStateMachine(state_machine.StateMachine):
    ...
    def __init__(self, instance, initial_state=INSTANCE_STATE.INITIAL):
        super().__init__(
            ...
            None,
            None,
            INSTANCE_FAIL_STATES[initial_state],
