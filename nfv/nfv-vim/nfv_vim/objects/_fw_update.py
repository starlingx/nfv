...
class FwUpdate(SwUpdate):
    ...
    def __init__(self, sw_update_uuid=None, strategy_data=None):
        super().__init__(
            sw_update_type=SW_UPDATE_TYPE.FW_UPDATE,
    ...
    def nfvi_update(self):
        ...
        if self.strategy.is_applying():
            ...
            for fw_update_host in self._fw_update_hosts:
                if not self._alarms:
                    self._alarms = alarm.raise_sw_update_alarm(
    ...
    def nfvi_audit(self):
        ...
        while True:
            ...
            DLOG.verbose("Audit firmware update still running, timer_id=%s." % timer_id)
