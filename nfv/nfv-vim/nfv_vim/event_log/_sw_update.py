    ...
    event_log.EVENT_ID.SW_PATCH_AUTO_APPLY_ABORT_REJECTED: {
        ...
        "event_context_data": {
            event_log.EVENT_CONTEXT.ADMIN: {
                "entity_type": "orchestration",
                "entity": "orchestration=sw-patch",
                "reason_text": "Software patch auto-apply abort rejected%(reason)s",
            }
        },
    },
    ...
    event_log.EVENT_ID.SYSTEM_CONFIG_UPDATE_AUTO_APPLY_CANCELLED: {
        ...
        "event_context_data": {
            event_log.EVENT_CONTEXT.ADMIN: {
                "entity_type": "orchestration",
                "entity": "orchestration=system-config-update",
                "reason_text": "System config update auto-apply cancelled%(reason)s",
            }
        },
    },
    event_log.EVENT_ID.SYSTEM_CONFIG_UPDATE_AUTO_APPLY_FAILED: {
        ...
        "event_context_data": {
            event_log.EVENT_CONTEXT.ADMIN: {
                "entity_type": "orchestration",
                "entity": "orchestration=system-config-update",
                "reason_text": "System config update auto-apply failed%(reason)s",
            }
        },
    },
