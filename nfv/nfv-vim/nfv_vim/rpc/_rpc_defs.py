...
class _RPCMessageType(Constants, metaclass=Singleton):
    ...
    CREATE_KUBE_ROOTCA_UPDATE_STRATEGY_REQUEST = Constant(
        "create-kube-rootca-update-strategy-request"
    )
    CREATE_KUBE_UPGRADE_STRATEGY_REQUEST = Constant(
        "create-kube-upgrade-strategy-request"
    )
    CREATE_SW_UPGRADE_STRATEGY_REQUEST = Constant("create-sw-upgrade-strategy-request")
    CREATE_SYSTEM_CONFIG_UPDATE_STRATEGY_REQUEST = Constant(
        "create-system-config-update-strategy-request"
    )
