...
class APIRequestCreateInstance(RPCMessage):
    ...
    def __init__(
        self,
        msg_version=RPC_MSG_VERSION.VERSION_1_0,
    ...
    def serialize_payload(self, msg):
        ...
        msg["hw:wrs:live_migration_max_downtime"] = self.live_migration_max_downtime
    ...
    def deserialize_payload(self, msg):
        ...
        self.live_migration_timeout = msg.get("hw:wrs:live_migration_timeout", None)
        self.live_migration_max_downtime = msg.get(
...
class APIResponseCreateInstance(RPCMessage):
    ...
    def deserialize_payload(self, msg):
        ...
        self.instance_type_original_name = msg.get("instance_type_original_name", None)
        self.image_uuid = msg.get("image_uuid", None)
        self.vcpus = msg.get("vcpus", None)
        self.memory_mb = msg.get("memory_mb", None)
        self.disk_gb = msg.get("disk_gb", None)
