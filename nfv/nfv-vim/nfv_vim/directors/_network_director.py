...
class NetworkDirector(metaclass=Singleton):
    ...
    def _subnet_create_callback(
        ...
        callback(
            response["completed"], network_uuid, subnet_name, subnet_ip, subnet_prefix
        )
    ...
    def subnet_create(
        ...
        nfvi.nfvi_create_subnet(
            ...
            gateway_ip,
            dhcp_enabled,
            self._subnet_create_callback(
                network_uuid, subnet_name, subnet_ip, subnet_prefix, callback
            ),
        )
    ...
    def network_create(
        ...
        nfvi.nfvi_create_network(
            ...
            physical_network,
            shared,
            self._network_create_callback(network_name, callback),
        )
