...
class OrchestrationDescription(wsme_types.Base):
    ...
    def convert(cls):
        ...
        description.links = [
            ...
            Link.make_link(
                "system-config-update", url, "orchestration/system-config-update", ""
            ),
            Link.make_link(
                "kube-rootca-update", url, "orchestration/kube-rootca-update", ""
            ),
            Link.make_link("kube-upgrade", url, "orchestration/kube-upgrade", ""),
            Link.make_link("fw-update", url, "orchestration/fw-update", ""),
            Link.make_link(
                "current-strategy", url, "orchestration/current-strategy", ""
            ),
        ]
        return description
