...
class NetworkSubnetType(wsme_types.Base):
    ...
    gateway_ip = wsme_types.wsattr(str, mandatory=False, default=None)
    ...
    # Extensions
    wrs_subnet_ip = wsme_types.wsattr(str, mandatory=True)
...
class NetworkSubnetResourceType(wsme_types.Base):
    ...
    status = wsme_types.wsattr(str, mandatory=False)
...
class NetworkType(wsme_types.Base):
    ...
    # Extensions
    wrs_physical_network = wsme_types.wsattr(str, mandatory=False)
