...
def _system_state_query_callback():
    ...
    if response["completed"]:
            ...
            for host_data in result_data:
                ...
                if host is not None:
                    if objects.HOST_PERSONALITY.WORKER in host.personality:
                        DLOG.info(
                            "Host %s uptime is %s, host_uuid=%s."
                            % (
                                host_data["hostname"],
                                host_data["uptime"],
                                host_data["uuid"],
        ...
        if _dor_completed:
            ...
            _alarm_data = alarm.raise_general_alarm(
