...
_alarm_templates = {
    ...
    alarm.ALARM_TYPE.SW_UPGRADE_AUTO_APPLY_INPROGRESS: {
        ...
        "repair_action": (
            "Wait for software deploy auto-apply to complete; "
            "if problem persists contact next level of support"
        ),
        "exclude_alarm_context": [alarm.ALARM_CONTEXT.TENANT],
    },
    ...
    alarm.ALARM_TYPE.SW_UPGRADE_AUTO_APPLY_FAILED: {
        ...
        "repair_action": (
            "Attempt to perform software deploy manually; if "
            "problem persists contact next level of support"
        ),
        "exclude_alarm_context": [alarm.ALARM_CONTEXT.TENANT],
    },
    alarm.ALARM_TYPE.FW_UPDATE_AUTO_APPLY_INPROGRESS: {
        ...
        "repair_action": (
            "Wait for firmware update auto-apply to complete; "
            "if problem persists contact next level of support"
        ),
        "exclude_alarm_context": [alarm.ALARM_CONTEXT.TENANT],
    },
    alarm.ALARM_TYPE.FW_UPDATE_AUTO_APPLY_ABORTING: {
        ...
        "repair_action": (
            "Wait for firmware update auto-apply abort to "
    ...
    alarm.ALARM_TYPE.FW_UPDATE_AUTO_APPLY_FAILED: {
        ...
        "repair_action": (
            "Attempt to apply firmware update manually; if "
            "problem persists contact next level of support"
        ),
        "exclude_alarm_context": [alarm.ALARM_CONTEXT.TENANT],
    },
    alarm.ALARM_TYPE.KUBE_ROOTCA_UPDATE_AUTO_APPLY_INPROGRESS: {
        ...
        "repair_action": (
            "Wait for kubernetes rootca update auto-apply to "
            "complete; if problem persists contact next "
            "level of support"
        ),
        "exclude_alarm_context": [alarm.ALARM_CONTEXT.TENANT],
    ...
    alarm.ALARM_TYPE.KUBE_ROOTCA_UPDATE_AUTO_APPLY_ABORTING: {
        ...
        "repair_action": (
            "Wait for kubernetes rootca update auto-apply abort "
    ...
    alarm.ALARM_TYPE.KUBE_ROOTCA_UPDATE_AUTO_APPLY_FAILED: {
        ...
        "repair_action": (
            "Attempt to apply kubernetes rootca update "
    ...
    alarm.ALARM_TYPE.KUBE_UPGRADE_AUTO_APPLY_INPROGRESS: {
        ...
        "repair_action": (
            "Wait for kubernetes upgrade auto-apply to complete; "
            "if problem persists contact next level of support"
        ),
        "exclude_alarm_context": [alarm.ALARM_CONTEXT.TENANT],
    },
    alarm.ALARM_TYPE.KUBE_UPGRADE_AUTO_APPLY_ABORTING: {
        ...
        "repair_action": (
            "Wait for kubernetes upgrade auto-apply abort to "
            "complete; if problem persists contact next "
            "level of support"
        ),
        "exclude_alarm_context": [alarm.ALARM_CONTEXT.TENANT],
    ...
    alarm.ALARM_TYPE.KUBE_UPGRADE_AUTO_APPLY_FAILED: {
        ...
        "repair_action": (
            "Attempt to apply kubernetes upgrade manually; if "
            "problem persists contact next level of support"
        ),
        "exclude_alarm_context": [alarm.ALARM_CONTEXT.TENANT],
    },
    alarm.ALARM_TYPE.SYSTEM_CONFIG_UPDATE_AUTO_APPLY_INPROGRESS: {
        ...
        "repair_action": (
            "Wait for system config update auto-apply to "
            "complete; if problem persists contact next "
            "level of support"
        ),
        "exclude_alarm_context": [alarm.ALARM_CONTEXT.TENANT],
    ...
    alarm.ALARM_TYPE.SYSTEM_CONFIG_UPDATE_AUTO_APPLY_ABORTING: {
        ...
        "repair_action": (
            "Wait for system config update auto-apply abort "
            "to complete; if problem persists contact next "
            "level of support"
        ),
        "exclude_alarm_context": [alarm.ALARM_CONTEXT.TENANT],
    ...
    alarm.ALARM_TYPE.SYSTEM_CONFIG_UPDATE_AUTO_APPLY_FAILED: {
        ...
        "repair_action": (
            "Attempt to apply system config update manually; "
            "if problem persists contact next level of support"
        ),
        "exclude_alarm_context": [alarm.ALARM_CONTEXT.TENANT],
    },
