...
class _EventId(Constants):
    ...
    KUBE_ROOTCA_UPDATE_AUTO_APPLY_START = Constant('kube-rootca-update-auto-apply-started')
    KUBE_ROOTCA_UPDATE_AUTO_APPLY_INPROGRESS = Constant('kube-rootca-update-auto-apply-inprogress')
    KUBE_ROOTCA_UPDATE_AUTO_APPLY_REJECTED = Constant('kube-rootca-update-auto-apply-rejected')
    KUBE_ROOTCA_UPDATE_AUTO_APPLY_CANCELLED = Constant('kube-rootca-update-auto-apply-cancelled')
    KUBE_ROOTCA_UPDATE_AUTO_APPLY_FAILED = Constant('kube-rootca-update-auto-apply-failed')
    KUBE_ROOTCA_UPDATE_AUTO_APPLY_COMPLETED = Constant('kube-rootca-update-auto-apply-completed')
    KUBE_ROOTCA_UPDATE_AUTO_APPLY_ABORT = Constant('kube-rootca-update-auto-apply-abort')
    KUBE_ROOTCA_UPDATE_AUTO_APPLY_ABORTING = Constant('kube-rootca-update-auto-apply-aborting')
    KUBE_ROOTCA_UPDATE_AUTO_APPLY_ABORT_REJECTED = Constant('kube-rootca-update-auto-apply-abort-rejected')
    KUBE_ROOTCA_UPDATE_AUTO_APPLY_ABORT_FAILED = Constant('kube-rootca-update-auto-apply-abort-failed')
    KUBE_ROOTCA_UPDATE_AUTO_APPLY_ABORTED = Constant('kube-rootca-update-auto-apply-aborted')
