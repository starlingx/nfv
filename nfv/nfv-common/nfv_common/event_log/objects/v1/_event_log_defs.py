...
class _EventId(Constants, metaclass=Singleton):
    ...
    INSTANCE_COLD_MIGRATE_CONFIRM_BEGIN = Constant(
        "instance-cold-migrate-confirm-begin"
    )
    INSTANCE_COLD_MIGRATE_CONFIRMING = Constant("instance-cold-migrate-confirming")
    INSTANCE_COLD_MIGRATE_CONFIRM_REJECTED = Constant(
        "instance-cold-migrate-confirm-rejected"
    )
    INSTANCE_COLD_MIGRATE_CONFIRM_CANCELLED = Constant(
        "instance-cold-migrate-confirm-cancelled"
    )
    INSTANCE_COLD_MIGRATE_CONFIRM_FAILED = Constant(
        "instance-cold-migrate-confirm-failed"
    )
    ...
    INSTANCE_COLD_MIGRATE_REVERT_REJECTED = Constant(
        "instance-cold-migrate-revert-rejected"
    )
    INSTANCE_COLD_MIGRATE_REVERT_CANCELLED = Constant(
        "instance-cold-migrate-revert-cancelled"
    )
    INSTANCE_COLD_MIGRATE_REVERT_FAILED = Constant(
        "instance-cold-migrate-revert-failed"
    )
    ...
    INSTANCE_GUEST_HEARTBEAT_ESTABLISHED = Constant(
        "instance-guest-heartbeat-established"
    )
    INSTANCE_GUEST_HEARTBEAT_DISCONNECTED = Constant(
        "instance-guest-heartbeat-disconnected"
    )
    ...
    SW_UPGRADE_AUTO_APPLY_ABORT_REJECTED = Constant(
        "sw-upgrade-auto-apply-abort-rejected"
    )
    ...
    FW_UPDATE_AUTO_APPLY_ABORT_REJECTED = Constant(
        "fw-update-auto-apply-abort-rejected"
    )
    ...
    KUBE_ROOTCA_UPDATE_AUTO_APPLY_START = Constant(
        "kube-rootca-update-auto-apply-started"
    )
    KUBE_ROOTCA_UPDATE_AUTO_APPLY_INPROGRESS = Constant(
        "kube-rootca-update-auto-apply-inprogress"
    )
    KUBE_ROOTCA_UPDATE_AUTO_APPLY_REJECTED = Constant(
        "kube-rootca-update-auto-apply-rejected"
    )
    KUBE_ROOTCA_UPDATE_AUTO_APPLY_CANCELLED = Constant(
        "kube-rootca-update-auto-apply-cancelled"
    )
    KUBE_ROOTCA_UPDATE_AUTO_APPLY_FAILED = Constant(
        "kube-rootca-update-auto-apply-failed"
    )
    KUBE_ROOTCA_UPDATE_AUTO_APPLY_COMPLETED = Constant(
        "kube-rootca-update-auto-apply-completed"
    )
    KUBE_ROOTCA_UPDATE_AUTO_APPLY_ABORT = Constant(
        "kube-rootca-update-auto-apply-abort"
    )
    KUBE_ROOTCA_UPDATE_AUTO_APPLY_ABORTING = Constant(
        "kube-rootca-update-auto-apply-aborting"
    )
    KUBE_ROOTCA_UPDATE_AUTO_APPLY_ABORT_REJECTED = Constant(
        "kube-rootca-update-auto-apply-abort-rejected"
    )
    KUBE_ROOTCA_UPDATE_AUTO_APPLY_ABORT_FAILED = Constant(
        "kube-rootca-update-auto-apply-abort-failed"
    )
    KUBE_ROOTCA_UPDATE_AUTO_APPLY_ABORTED = Constant(
        "kube-rootca-update-auto-apply-aborted"
    )
    ...
    KUBE_UPGRADE_AUTO_APPLY_ABORT_REJECTED = Constant(
        "kube-upgrade-auto-apply-abort-rejected"
    )
    KUBE_UPGRADE_AUTO_APPLY_ABORT_FAILED = Constant(
        "kube-upgrade-auto-apply-abort-failed"
    )
    KUBE_UPGRADE_AUTO_APPLY_ABORTED = Constant("kube-upgrade-auto-apply-aborted")

    SYSTEM_CONFIG_UPDATE_AUTO_APPLY_START = Constant(
        "system-config-update-auto-apply-started"
    )
    SYSTEM_CONFIG_UPDATE_AUTO_APPLY_INPROGRESS = Constant(
        "system-config-update-auto-apply-inprogress"
    )
    SYSTEM_CONFIG_UPDATE_AUTO_APPLY_REJECTED = Constant(
        "system-config-update-auto-apply-rejected"
    )
    SYSTEM_CONFIG_UPDATE_AUTO_APPLY_CANCELLED = Constant(
        "system-config-update-auto-apply-cancelled"
    )
    SYSTEM_CONFIG_UPDATE_AUTO_APPLY_FAILED = Constant(
        "system-config-update-auto-apply-failed"
    )
    SYSTEM_CONFIG_UPDATE_AUTO_APPLY_COMPLETED = Constant(
        "system-config-update-auto-apply-completed"
    )
    SYSTEM_CONFIG_UPDATE_AUTO_APPLY_ABORT = Constant(
        "system-config-update-auto-apply-abort"
    )
    SYSTEM_CONFIG_UPDATE_AUTO_APPLY_ABORTING = Constant(
        "system-config-update-auto-apply-aborting"
    )
    SYSTEM_CONFIG_UPDATE_AUTO_APPLY_ABORT_REJECTED = Constant(
        "system-config-update-auto-apply-abort-rejected"
    )
    SYSTEM_CONFIG_UPDATE_AUTO_APPLY_ABORT_FAILED = Constant(
        "system-config-update-auto-apply-abort-failed"
    )
    SYSTEM_CONFIG_UPDATE_AUTO_APPLY_ABORTED = Constant(
        "system-config-update-auto-apply-aborted"
    )
