...
class TestNFVPluginsK8SNodeTaint(testcase.NFVTestCase):
    ...
    def test_when_add_taint_and_get_then_get_it(self):
        assert (
            self.check_taint_exist(
                self.test_node_name, "NoExecute", self.test_key1, self.test_value1
            )
            is False
        )
    ...
    def test_when_add_two_taints_and_get_then_get_them(self):
        ...
        assert (
            self.check_taint_exist(
                self.test_node_name, "NoExecute", self.test_key2, self.test_value2
            )
            is False
        )
    ...
    def test_when_add_taint_twice_and_delete_it_and_get_then_get_none(self):
        kubernetes_client.taint_node(
            self.test_node_name, "NoSchedule", self.test_key1, self.test_value1
        )
        kubernetes_client.taint_node(
            self.test_node_name, "NoSchedule", self.test_key1, self.test_value1
        )
        ...
        kubernetes_client.untaint_node(
            self.test_node_name, "NoSchedule", self.test_key1
        )
        assert (
            self.check_taint_exist(
                self.test_node_name, "NoSchedule", self.test_key1, self.test_value1
...
class TestNFVPluginsK8SMarkAllPodsNotReady(testcase.NFVTestCase):
        ...
        items=[
            kubernetes.client.V1Pod(
                ...
                metadata=kubernetes.client.V1ObjectMeta(
                    name="test-pod-not-ready", namespace="test-namespace-1"
                ),
                status=kubernetes.client.V1PodStatus(
                    conditions=[
                        ...
                        kubernetes.client.V1PodCondition(status="False", type="Ready"),
                        kubernetes.client.V1PodCondition(
            ...
            kubernetes.client.V1Pod(
                ...
                kind="Pod",
                metadata=kubernetes.client.V1ObjectMeta(
                    name="test-pod-ready", namespace="test-namespace-1"
                ),
                status=kubernetes.client.V1PodStatus(
                    conditions=[
                        kubernetes.client.V1PodCondition(
                        ...
                        kubernetes.client.V1PodCondition(status="True", type="Ready"),
                        kubernetes.client.V1PodCondition(
                            status="True", type="ContainersReady"
                        ),
                        kubernetes.client.V1PodCondition(
            ...
            kubernetes.client.V1Pod(
                ...
                kind="Pod",
                metadata=kubernetes.client.V1ObjectMeta(
                    name="test-pod-no-ready-status", namespace="test-namespace-1"
                ),
                status=kubernetes.client.V1PodStatus(
                    conditions=[
                        kubernetes.client.V1PodCondition(
    ...
    def setUp(self):
        ...
        self.mocked_list_namespaced_pod = mock.patch(
            "kubernetes.client.CoreV1Api.list_namespaced_pod", mock_list_namespaced_pod
        )
...
class TestNFVPluginsK8SGetTerminatingPods(testcase.NFVTestCase):
    ...
    def test_get_terminating_with_two_terminating(self):
        ...
        assert result.result_data == "test-pod-terminating,test-pod-terminating-2"
...
class TestNFVPluginsK8SGetNamespacedRunningPods(testcase.NFVTestCase):
    ...
    list_namespaced_pod_result = kubernetes.client.V1PodList(
        ...
        items=[
            kubernetes.client.V1Pod(
                ...
                kind="Pod",
                metadata=kubernetes.client.V1ObjectMeta(
                    name="test-pod-not-found-1", namespace="test-namespace-1"
                ),
            ),
            kubernetes.client.V1Pod(
                api_version="v1",
                kind="Pod",
                metadata=kubernetes.client.V1ObjectMeta(
                    name="test-pod-not-found-2", namespace="test-namespace-1"
                ),
            ),
            kubernetes.client.V1Pod(
                api_version="v1",
                kind="Pod",
                metadata=kubernetes.client.V1ObjectMeta(
                    name="test-pod-found-1", namespace="test-namespace-1"
                ),
            ),
            kubernetes.client.V1Pod(
                api_version="v1",
                kind="Pod",
                metadata=kubernetes.client.V1ObjectMeta(
                    name="test-pod-found-2", namespace="test-namespace-1"
                ),
            ),
        ],
    )
    ...
    def test_get_terminating_with_two_terminating(self):
        ...
        result = kubernetes_client.get_namespaced_running_pods(
            namespace="test-namespace-1", name="test-pod-found"
        )

        assert result.result_data == "test-pod-found-1,test-pod-found-2"
