...
class TestNeutronRebalance(testcase.NFVTestCase):
    ...
    def test_rebalance_down_host_canned(self):
        ...
        _L3Rebalance.l3agents.append(
            {
                "datanets": ["physnet0", "physnet3"],
                "host": "compute-0",
                "id": "00000000-3de6-4717-93d4-0f23c38d2bf2",
                "host_uuid": "eb2eca67-1018-4c84-9b2c-b9c2662c41a6",
            }
        )
        _L3Rebalance.l3agents.append(
            {
                ...
                "host": "compute-2",
                "id": "22222222-5a5f-4c58-9399-12d0b8e7e321",
                "host_uuid": "021f35d2-4a98-41ab-87c5-2660cecd501d",
            }
        )
        _L3Rebalance.l3agents.append(
            {
                "datanets": ["physnet0", "physnet1"],
                "host": "compute-1",
                "id": "11111111-562c-438c-8083-0733ebbbe881",
                "host_uuid": "7ebc0819-2b11-4aa8-8ef1-3a5423c17eef",
            }
        )
        _L3Rebalance.l3agents.append(
            {
                "datanets": ["physnet0", "physnet1", "physnet3"],
                "host": "compute-3",
                "id": "33333333-8989-438c-7083-344322513677",
                "host_uuid": "23423524-8b11-4ba8-8ef1-2346625326eb",
            }
        )
        _L3Rebalance.l3agents.append(
            {
                "datanets": ["physnet0", "physnet1"],
                "host": "compute-5",
                "id": "55555555-930c-438c-6083-173472902843",
                "host_uuid": "09132345-7b11-4ca7-8ef1-3a5423c17ecd",
            }
        )
        _L3Rebalance.l3agents.append(
            {
                "datanets": ["physnet0", "physnet1", "physnet3"],
                "host": "compute-4",
                "id": "44444444-0074-438c-5083-023486659382",
                "host_uuid": "89891234-3b11-9da8-8ef1-aaa4a3a17aea",
            }
        )
        ...
        _L3Rebalance.router_ids_per_agent[agent_id].append(
            "fb6c7812-5aa6-4303-a8e8-654d2c61c107"
        )
        _L3Rebalance.router_ids_per_agent[agent_id].append(
            "f900c5a3-a8f2-4348-a63f-ed0b9d2ca2b1"
        )
        _L3Rebalance.router_ids_per_agent[agent_id].append(
            "71205e20-d42f-46d0-ad6b-dd325f9b959b"
        )
        _L3Rebalance.router_ids_per_agent[agent_id].append(
            "43223570-ab32-25d0-ae6c-352aaab23532"
        )
        _L3Rebalance.router_ids_per_agent[agent_id].append(
            "45692991-e52f-96c0-bd6d-ed428f9a969b"
        )
        _L3Rebalance.router_ids_per_agent[agent_id].append(
            "97867e20-a92e-1610-a161-1d121f1b151b"
        )
        ...
        _L3Rebalance.router_ids_per_agent[agent_id].append(
            "7c0909c6-c03f-4c14-9d05-e910ab5eb255"
        )
        _L3Rebalance.router_ids_per_agent[agent_id].append(
            "0c59b77a-b316-4963-90e5-bf689568ac58"
        )
        _L3Rebalance.router_ids_per_agent[agent_id].append(
            "23423422-3433-fdfd-2222-fdsdfsasvccd"
        )
        _L3Rebalance.router_ids_per_agent[agent_id].append(
            "11432542-aabb-3415-4443-xcvlkweroidd"
        )
        _L3Rebalance.router_ids_per_agent[agent_id].append(
            "sd093kds-b2dd-eb3d-23bs-asdwebesdedw"
        )
        ...
        _L3Rebalance.router_ids_per_agent[agent_id].append(
            "91f20f34-ad68-4483-9ae7-8f917a1460d8"
        )
        _L3Rebalance.router_ids_per_agent[agent_id].append(
            "23093482-bd68-4c83-cae9-9287467ababa"
        )
        ...
        _L3Rebalance.router_ids_per_agent[agent_id].append(
            "c1c8c935-6302-4c5d-98ee-c12bbd900abf"
        )
        ...
        _L3Rebalance.router_ids_per_agent[agent_id].append(
            "7ebc0819-2b11-4aa8-8ef1-3a5423c17eef"
        )
        ...
        _L3Rebalance.router_ids_per_agent[agent_id].append(
            "021f35d2-4a98-41ab-87c5-2660cecd501d"
        )
        ...
        _L3Rebalance.networks_per_router["fb6c7812-5aa6-4303-a8e8-654d2c61c107"] = [
            "physnet0",
            "physnet3",
        ]
        _L3Rebalance.networks_per_router["f900c5a3-a8f2-4348-a63f-ed0b9d2ca2b1"] = [
            "physnet0",
            "physnet3",
        ]
        _L3Rebalance.networks_per_router["71205e20-d42f-46d0-ad6b-dd325f9b959b"] = [
            "physnet0",
            "physnet3",
        ]
        _L3Rebalance.networks_per_router["43223570-ab32-25d0-ae6c-352aaab23532"] = [
            "physnet0",
            "physnet3",
        ]
        _L3Rebalance.networks_per_router["45692991-e52f-96c0-bd6d-ed428f9a969b"] = [
            "physnet0",
            "physnet3",
        ]
        _L3Rebalance.networks_per_router["97867e20-a92e-1610-a161-1d121f1b151b"] = [
            "physnet0",
            "physnet3",
        ]

        _L3Rebalance.networks_per_router["a913c4a3-4d6b-4a4d-9cf5-f8b7c30224a4"] = [
            "physnet0",
            "physnet1",
        ]
        _L3Rebalance.networks_per_router["7c0909c6-c03f-4c14-9d05-e910ab5eb255"] = [
            "physnet0",
            "physnet1",
        ]
        _L3Rebalance.networks_per_router["0c59b77a-b316-4963-90e5-bf689568ac58"] = [
            "physnet0",
            "physnet1",
        ]
        _L3Rebalance.networks_per_router["23423422-3433-fdfd-2222-fdsdfsasvccd"] = [
            "physnet0",
            "physnet1",
        ]
        _L3Rebalance.networks_per_router["11432542-aabb-3415-4443-xcvlkweroidd"] = [
            "physnet0",
            "physnet1",
        ]
        _L3Rebalance.networks_per_router["sd093kds-b2dd-eb3d-23bs-asdwebesdedw"] = [
            "physnet0",
            "physnet1",
        ]

        _L3Rebalance.networks_per_router["5054adb8-aef5-445d-b335-fc4bb3ee0871"] = [
            "physnet0",
            "physnet1",
        ]
        _L3Rebalance.networks_per_router["91f20f34-ad68-4483-9ae7-8f917a1460d8"] = [
            "physnet0",
            "physnet1",
        ]
        _L3Rebalance.networks_per_router["23093482-bd68-4c83-cae9-9287467ababa"] = [
            "physnet0",
            "physnet1",
        ]

        _L3Rebalance.networks_per_router["51019325-a1d4-410f-a83d-9eb54743dcf0"] = [
            "physnet0",
            "physnet1",
        ]
        _L3Rebalance.networks_per_router["c1c8c935-6302-4c5d-98ee-c12bbd900abf"] = [
            "physnet0",
            "physnet1",
        ]

        _L3Rebalance.networks_per_router["2e50468a-755a-4bfb-bc29-f7aadc66c598"] = [
            "physnet0",
            "physnet1",
        ]
        _L3Rebalance.networks_per_router["7ebc0819-2b11-4aa8-8ef1-3a5423c17eef"] = [
            "physnet0",
            "physnet1",
        ]

        _L3Rebalance.networks_per_router["4c0213e7-4b36-439b-9e47-d5509e0950f1"] = [
            "physnet0",
            "physnet1",
        ]
        _L3Rebalance.networks_per_router["021f35d2-4a98-41ab-87c5-2660cecd501d"] = [
            "physnet0",
            "physnet1",
        ]
        ...
        if DEBUG_PRINTING:
            ...
            print(
                "_L3Rebalance.router_ids_per_agent= %s"
        ...
        _L3Rebalance.l3agents.append(
            {
                ...
                "host_uuid": "bbbaaac4-3b21-87a8-65f1-6a3422a11aba",
            }
        )
    ...
    def rebalance(self, host_name=None):
        ...
        if DEBUG_PRINTING:
            print(
                "Test 2 _L3Rebalance.num_routers_on_agents= %s"
                % _L3Rebalance.num_routers_on_agents
            )
