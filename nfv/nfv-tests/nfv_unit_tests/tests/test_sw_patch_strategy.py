...
@mock.patch(
    "nfv_vim.strategy._strategy.get_local_host_name", sw_update_testcase.fake_host_name
)
@mock.patch(
...
class TestSwPatchStrategy(sw_update_testcase.SwUpdateStrategyTestCase):
    ...
    def test_sw_patch_strategy_worker_stages_ignore(self):
        ...
        expected_results = {"total_stages": 0}
            ...
            "stages": [
                {
                    ...
                    "steps": [
                        ...
                        {"name": "migrate-instances-from-host", "entity_names": []},
                        {
                            "name": "lock-hosts",
                ...
                },
                {
                    ...
                    "steps": [
                        ...
                        {"name": "sw-patch-hosts", "entity_names": ["compute-0"]},
                        {"name": "system-stabilize", "timeout": 15},
                ...
                },
                {
                    ...
                    "steps": [
                        ...
                        {"name": "sw-patch-hosts", "entity_names": ["compute-1"]},
                        {"name": "system-stabilize", "timeout": 15},
            ...
            "stages": [
                ...
                },
                {
                    ...
                    "steps": [
                        ...
                        {
                            "name": "migrate-instances-from-host",
                            "entity_names": ["test_instance_3", "test_instance_4"],
                        },
                        {
                            "name": "lock-hosts",
    ...
    def test_sw_patch_strategy_worker_stages_parallel_migrate_host_aggregate(self):
        ...
        self.create_host_aggregate(
            "aggregate-1",
            ["compute-0", "compute-1", "compute-2", "compute-3", "compute-4"],
        )
        self.create_host_aggregate(
            "aggregate-2",
            ["compute-5", "compute-6", "compute-7", "compute-8", "compute-9"],
        )
            ...
            "stages": [
                ...
                },
                {
                    ...
                    "steps": [
                        ...
                        {
                            "name": "migrate-instances-from-host",
                            "entity_names": ["test_instance_0", "test_instance_6"],
                        },
                        {
                            "name": "lock-hosts",
                ...
                },
                {
                    ...
                    "steps": [
                        ...
                        {
                            "name": "migrate-instances-from-host",
                            "entity_names": ["test_instance_2", "test_instance_7"],
                        },
                        {
                            "name": "lock-hosts",
                ...
                },
                {
                    ...
                    "steps": [
                        ...
                        {
                            "name": "migrate-instances-from-host",
                            "entity_names": ["test_instance_3", "test_instance_8"],
                        },
                        {
                            "name": "lock-hosts",
                ...
                },
                {
                    ...
                    "steps": [
                        ...
                        {
                            "name": "migrate-instances-from-host",
                            "entity_names": ["test_instance_4", "test_instance_9"],
                        },
                        {
                            "name": "lock-hosts",
    ...
    def test_sw_patch_strategy_worker_stages_parallel_migrate_small_host_aggregate(
        ...
        self.create_host_aggregate(
            "aggregate-2",
            ["compute-2", "compute-3", "compute-4", "compute-5", "compute-6"],
        )
        self.create_host_aggregate(
            "aggregate-3", ["compute-7", "compute-8", "compute-9"]
        )
            ...
            "stages": [
                ...
                },
                {
                    ...
                    "steps": [
                        ...
                        {
                            "name": "migrate-instances-from-host",
                            "entity_names": ["test_instance_4", "test_instance_7"],
                        },
                        {
                            "name": "lock-hosts",
                ...
                },
                {
                    ...
                    "steps": [
                        ...
                        {
                            "name": "migrate-instances-from-host",
                            "entity_names": ["test_instance_5", "test_instance_8"],
                        },
                        {
                            "name": "lock-hosts",
                ...
                },
                {
                    ...
                    "steps": [
                        ...
                        {
                            "name": "migrate-instances-from-host",
                            "entity_names": ["test_instance_6", "test_instance_9"],
                        },
                        {
                            "name": "lock-hosts",
        ...
        expected_results = {
            ...
            "stages": [
                ...
                },
                {
                    ...
                    "steps": [
                        {"name": "query-alarms"},
                        {"name": "stop-instances", "entity_names": ["test_instance_1"]},
                        {"name": "lock-hosts", "entity_names": ["compute-1"]},
                        {"name": "sw-patch-hosts", "entity_names": ["compute-1"]},
                        {"name": "system-stabilize", "timeout": 15},
                        {"name": "unlock-hosts", "entity_names": ["compute-1"]},
    ...
    def test_sw_patch_strategy_worker_stages_parallel_stop_start_host_aggregate(self):
        ...
        strategy._add_worker_strategy_stages(
            worker_hosts=sorted_worker_hosts, reboot=False
        )
        ...
        expected_results = {
            ...
            "stages": [
                ...
                },
                {
                    ...
                    "steps": [
                        {"name": "query-alarms"},
                        {"name": "sw-patch-hosts", "entity_names": ["compute-3"]},
                        {"name": "system-stabilize", "timeout": 30},
                    ],
                },
            ],
    ...
    def test_sw_patch_strategy_worker_stages_parallel_stop_start_locked_host(self):
        ...
        self.create_host("compute-2")
        self.create_host(
            "compute-3", admin_state=nfvi.objects.v1.HOST_ADMIN_STATE.LOCKED
        )
            ...
            "stages": [
                {
                    ...
                    "steps": [
                        ...
                        {"name": "reboot-hosts", "entity_names": ["compute-3"]},
                        {"name": "wait-alarms-clear", "timeout": 600},
                    ],
                },
                {
            ...
            "stages": [
                {
                    ...
                    "steps": [
                        {"name": "query-alarms"},
                        {"name": "lock-hosts", "entity_names": ["compute-2"]},
                        {"name": "sw-patch-hosts", "entity_names": ["compute-2"]},
                        {"name": "system-stabilize", "timeout": 15},
                        {"name": "unlock-hosts", "entity_names": ["compute-2"]},
    ...
    def test_sw_patch_strategy_worker_stages_serial_stop_start_locked_host(self):
        ...
        self.create_host("compute-1")
        self.create_host(
            "compute-2", admin_state=nfvi.objects.v1.HOST_ADMIN_STATE.LOCKED
        )
        self.create_host("compute-3")
            ...
            "stages": [
                {
                    ...
                    "steps": [
                        ...
                        {"name": "sw-patch-hosts", "entity_names": ["compute-2"]},
                        {"name": "system-stabilize", "timeout": 15},
                        {"name": "reboot-hosts", "entity_names": ["compute-2"]},
                        {"name": "wait-alarms-clear", "timeout": 600},
                    ],
                },
                {
                ...
                },
                {
                    ...
                    "steps": [
                        {"name": "query-alarms"},
                        {"name": "stop-instances", "entity_names": ["test_instance_2"]},
                        {"name": "lock-hosts", "entity_names": ["compute-3"]},
                        {"name": "sw-patch-hosts", "entity_names": ["compute-3"]},
                        {"name": "system-stabilize", "timeout": 15},
                        {"name": "unlock-hosts", "entity_names": ["compute-3"]},
            ...
            "stages": [
                ...
                },
                {
                    ...
                    "steps": [
                        ...
                        {
                            "name": "lock-hosts",
                            "entity_names": ["compute-10", "compute-11", "compute-12"],
                        },
                        {
                            "name": "sw-patch-hosts",
                            "entity_names": ["compute-10", "compute-11", "compute-12"],
    ...
    def test_sw_patch_strategy_storage_stages_ignore(self):
        ...
        success, reason = strategy._add_storage_strategy_stages(
            storage_hosts=sorted_storage_hosts, reboot=True
        )
    ...
    def test_sw_patch_strategy_storage_stages_parallel_host_group(self):
        ...
        strategy._add_storage_strategy_stages(
            storage_hosts=sorted_storage_hosts, reboot=True
        )
        ...
        strategy._add_storage_strategy_stages(
            storage_hosts=sorted_storage_hosts, reboot=False
        )
            ...
            "stages": [
                {
                    ...
                    "steps": [
                        {"name": "query-alarms"},
                        {"name": "lock-hosts", "entity_names": ["storage-0"]},
                        {"name": "sw-patch-hosts", "entity_names": ["storage-0"]},
                        {"name": "system-stabilize", "timeout": 15},
                        {"name": "unlock-hosts", "entity_names": ["storage-0"]},
                        {
                            "name": "wait-data-sync",
                            "ignore_alarms": [
                                "900.001",
                ...
                },
                {
                    ...
                    "steps": [
                        {"name": "query-alarms"},
                        {"name": "lock-hosts", "entity_names": ["storage-1"]},
                        {"name": "sw-patch-hosts", "entity_names": ["storage-1"]},
                        {"name": "system-stabilize", "timeout": 15},
                        {"name": "unlock-hosts", "entity_names": ["storage-1"]},
                        {
                            "name": "wait-data-sync",
                            "ignore_alarms": [
                                "900.001",
                ...
                },
                {
                    ...
                    "steps": [
                        {"name": "query-alarms"},
                        {"name": "lock-hosts", "entity_names": ["storage-2"]},
                        {"name": "sw-patch-hosts", "entity_names": ["storage-2"]},
                        {"name": "system-stabilize", "timeout": 15},
                        {"name": "unlock-hosts", "entity_names": ["storage-2"]},
                        {
                            "name": "wait-data-sync",
                            "ignore_alarms": [
                                "900.001",
                ...
                },
                {
                    ...
                    "steps": [
                        {"name": "query-alarms"},
                        {"name": "lock-hosts", "entity_names": ["storage-3"]},
                        {"name": "sw-patch-hosts", "entity_names": ["storage-3"]},
                        {"name": "system-stabilize", "timeout": 15},
                        {"name": "unlock-hosts", "entity_names": ["storage-3"]},
                        {
                            "name": "wait-data-sync",
                            "ignore_alarms": [
                                "900.001",
    ...
    def test_sw_patch_strategy_controller_stages_serial(self):
            ...
            "stages": [
                {
                    ...
                    "steps": [
                        ...
                        {"name": "sw-patch-hosts", "entity_names": ["controller-1"]},
                        {"name": "system-stabilize", "timeout": 15},
                ...
                },
                {
                    ...
                    "steps": [
                        ...
                        {"name": "sw-patch-hosts", "entity_names": ["controller-0"]},
                        {"name": "system-stabilize", "timeout": 15},
        ...
        strategy._add_controller_strategy_stages(
            controllers=controller_hosts, reboot=False
        )
    ...
    def test_sw_patch_strategy_aio_plus_stages_parallel_stop_start(self):
        ...
        self.create_instance("small", "test_instance_2", "compute-0")
        self.create_instance("small", "test_instance_3", "compute-1")
        ...
        expected_results = {
            ...
            "stages": [
                ...
                },
                {
                    ...
                    "steps": [
                        {"name": "query-alarms"},
                        {"name": "stop-instances", "entity_names": ["test_instance_3"]},
                        {"name": "lock-hosts", "entity_names": ["compute-1"]},
                        {"name": "sw-patch-hosts", "entity_names": ["compute-1"]},
                        {"name": "system-stabilize", "timeout": 15},
                        {"name": "unlock-hosts", "entity_names": ["compute-1"]},
    ...
    def test_sw_patch_strategy_aio_simplex_stages_serial_migrate(self):
        ...
        success, reason = strategy._add_worker_strategy_stages(
            worker_hosts=worker_hosts, reboot=True
        )
    ...
    def test_sw_patch_strategy_aio_simplex_stages_serial_no_openstack(self):
        ...
        strategy._add_worker_strategy_stages(worker_hosts=worker_hosts, reboot=True)
